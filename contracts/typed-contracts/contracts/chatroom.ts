...
import { ContractAbi } from '../contract-info/chatroom';
import QueryMethods from '../query/chatroom';
import BuildExtrinsicMethods from '../build-extrinsic/chatroom';
import TxSignAndSendMethods from '../tx-sign-and-send/chatroom';
import MixedMethods from '../mixed-methods/chatroom';
import EventsClass from '../events/chatroom';
